...
public class JobApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call jobGroupsPostCall(JobGroup jobGroup, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = jobGroup;
        
        // create path and map variables
        String localVarPath = "/job/groups";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call jobGroupsPostValidateBeforeCall(JobGroup jobGroup, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'jobGroup' is set
        if (jobGroup == null) {
            throw new ApiException("Missing the required parameter 'jobGroup' when calling jobGroupsPost(Async)");
        }
        
        
        com.squareup.okhttp.Call call = jobGroupsPostCall(jobGroup, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void jobGroupsPost(JobGroup jobGroup) throws ApiException {
        jobGroupsPostWithHttpInfo(jobGroup);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> jobGroupsPostWithHttpInfo(JobGroup jobGroup) throws ApiException {
        com.squareup.okhttp.Call call = jobGroupsPostValidateBeforeCall(jobGroup, null, null);
        return apiClient.execute(call);
    }

    /**
     * 创建一个jobgroup 名字、第几步、描述 (asynchronously)
     * 
     * @param jobGroup  (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call jobGroupsPostAsync(JobGroup jobGroup, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = jobGroupsPostValidateBeforeCall(jobGroup, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<Job> jobsGet() throws ApiException {
        ApiResponse<List<Job>> resp = jobsGetWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Job>> jobsGetWithHttpInfo() throws ApiException {
    ...
    /**
     * 获取任务列表 (asynchronously)
     * 
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call jobsGetAsync(final ApiCallback<List<Job>> callback) throws ApiException {
