...
NSString *const LJobDeserializationErrorDomainKey = @"LJobDeserializationErrorDomainKey";

NSInteger const LJobTypeMismatchErrorCode = 143553;

NSInteger const LJobEmptyValueOccurredErrorCode = 143509;

NSInteger const LJobUnknownResponseObjectErrorCode = 143528;


@interface LJobResponseDeserializer ()
...
@implementation LJobResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:LJobDeserializationErrorDomainKey code:LJobTypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:LJobDeserializationErrorDomainKey code:LJobEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:LJobDeserializationErrorDomainKey code:LJobUnknownResponseObjectErrorCode userInfo:userInfo];
}
